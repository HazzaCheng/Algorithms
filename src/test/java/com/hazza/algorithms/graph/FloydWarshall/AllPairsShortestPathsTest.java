package com.hazza.algorithms.graph.FloydWarshall;
...
public class AllPairsShortestPathsTest {
    ...
    public void testRight() {
        ...
        int[][] expeceted2 = com.hazza.algorithms.matrix.FastMatrixExponentiation.AllPairsShortestPaths.showAllPairsShortestPaths_fast(5, edges);
